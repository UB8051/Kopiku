...
public class DBHelper extends SQLiteOpenHelper {
    ...
    Boolean insertKeuntungan(String kode_transaksi, double laba){
        ContentValues values = new ContentValues();
        values.put("kode_transaksi",kode_transaksi);
    ...
    Boolean masukkanKeranjang(int kode_produk, String nama_produk, double harga_produk, double harga_pokok, int jumlah){
        ContentValues values = new ContentValues();
        values.put("kode_produk",kode_produk);
        values.put("nama_produk", nama_produk);
